...
#define EFFECT_TEXTURE_SIZE_X	(75)		// テクスチャサイズ
#define EFFECT_TEXTURE_SIZE_Y	(75)		// 同上
...
static char* g_TexturName[] = {
	...
	"data/TEXTURE/summoner_magic_circle.png",
...
void ResetParticle(int i, int n) 
{
	effectWk[i].pParticle[n].pos = effectWk[i].pos;
